...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    key: "convertCurrency",
    value: function convertCurrency() {// console.log("HIII");
      //console.log('fromCurrency:::', fromCurrency);
      //let fromTo = this.state.fromCurrency + this.state.toCurrency;
      // this.state.baseToTermCurrencies.map(record =>
      //     {
      //         return(
      //             <div></div>
      //         )
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("h3", null, " FX Calculator"), _react.default.createElement("form", null, _react.default.createElement("label", {
        for: "fromCurrency"
      }, "From:"), _react.default.createElement("select", {
        id: "fromCurrency",
        ...
        value: "AUD"
      }, "AUD"), _react.default.createElement("option", {
        value: "CAD"
      }, "CAD"), _react.default.createElement("option", {
        value: "CNY"
      }, "CNY"), _react.default.createElement("option", {
        value: "CSZ"
      }, "CSZ"), _react.default.createElement("option", {
        value: "DKK"
      }, "DKK"), _react.default.createElement("option", {
        value: "EUR"
      }, "EUR"), _react.default.createElement("option", {
        value: "GBP"
      }, "GBP"), _react.default.createElement("option", {
        value: "JPY"
      }, "JPY"), _react.default.createElement("option", {
        value: "NOK"
      }, "NOK"), _react.default.createElement("option", {
        value: "NZD"
      }, "NZD"), _react.default.createElement("option", {
        value: "USD"
      }, "USD")), _react.default.createElement("label", {
        for: "amount"
      }, "Amount"), _react.default.createElement("input", {
        type: "text",
        id: "amount",
        name: "amount",
        placeholder: "Amount",
        ...
        for: "toCurrency"
      }, "To:"), _react.default.createElement("select", {
        id: "toCurrency",
        onChange: function onChange(event) {
          return _this2.setState({
        ...
        value: "USD"
      }, "USD")), _react.default.createElement("button", {
        type: "submit",
